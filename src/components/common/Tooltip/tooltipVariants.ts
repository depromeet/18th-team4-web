...
export const tooltipVariants = cva(
  'body2-bold relative inline-block whitespace-nowrap rounded-[10px] bg-gray-800 px-[1.2rem] py-[1rem] text-center text-gray-white tracking-[-0.03rem] select-none',
);
