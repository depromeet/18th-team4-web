  ...
  return createPortal(
    <>
      ...
      <dialog
        ...
        className={cn(
          'fixed top-1/2 left-1/2 z-modal m-0 flex max-h-[90dvh] min-w-0 w-[min(33rem,calc(100vw-4.8rem))] flex-col items-center gap-[3rem] overflow-y-auto overscroll-contain rounded-[20px] border-none bg-text-white p-[2.4rem] pt-[2.8rem] shadow-none',
